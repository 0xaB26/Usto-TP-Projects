dans ce TP, nous allons créer un code C pour un microcontrôleur pic16F877 qui lit une valeur analogique sur la broche A0 et affiche le résultat sur l'écran LCD.
